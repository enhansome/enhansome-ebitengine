...
[Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 13,489 | 🐛 295 | 🌐 Go | 📅 2026-09-17 is an open source game library for the Go programming language. Ebitengine's simple API allows you to quickly and easily develop 2D games that can be deployed across multiple platforms. Ebitengine is made by [Hajime Hoshi](https://github.com/hajimehoshi).

### Contributing

Please take a quick gander at the [contribution guidelines](https://github.com/sedyh/awesome-ebiten/blob/main/CONTRIBUTING.md) ⭐ 992 | 🐛 1 | 📅 2026-09-17 first. Thanks to all [contributors](https://github.com/sedyh/awesome-ebiten/graphs/contributors) ⭐ 992 | 🐛 1 | 📅 2026-09-17; you rock!
...
* [furex](https://github.com/yohamta/furex) ⭐ 170 | 🐛 8 | 🌐 Go | 📅 2026-09-16 - A simple UI framework with a subset of flexbox layout specification.
...
* [go-colorful](https://github.com/lucasb-eyer/go-colorful) ⭐ 1,256 | 🐛 9 | 🌐 Go | 📅 2026-08-02 - A complex library for handling color spaces and comparing colors.
* [tetra3d](https://github.com/SolarLune/Tetra3d) ⭐ 518 | 🐛 4 | 🌐 Go | 📅 2026-08-19 - A 3D software renderer written in Go by means of Ebitengine, primarily for video games.
...
* [ganim8](https://github.com/yohamta/ganim8) ⭐ 83 | 🐛 0 | 🌐 Go | 📅 2026-08-16 - An animation library for Ebitengine inspired by [anim8](https://github.com/kikito/anim8) ⭐ 993 | 🐛 7 | 🌐 Lua | 📅 2022-01-20.
...
* [jel](https://github.com/setanarut/jel) ⭐ 1 | 🐛 0 | 🌐 Go | 📅 2026-09-16 - 2D soft-body physics library with extensible architecture
* [quark](https://github.com/setanarut/quark) ⭐ 1 | 🐛 0 | 🌐 Go | 📅 2026-08-25 - A Go port of [QuarkPhysics](https://github.com/erayzesen/QuarkPhysics) ⭐ 295 | 🐛 0 | 🌐 C++ | 📅 2025-10-17, a 2D physics engine for games.
...
* [kassetpack](https://github.com/kadevland/kassetpack) ⭐ 0 | 🐛 0 | 🌐 Go | 📅 2026-09-16 - Lightweight asset packaging with deduplication, splitting, and XOR obfuscation.
...
* [tengo](https://github.com/d5/tengo) ⭐ 3,838 | 🐛 91 | 🌐 Go | 📅 2026-04-29 - Fast scripting language for Go.
...
* [kcp-go](https://github.com/xtaci/kcp-go) ⭐ 4,555 | 🐛 70 | 🌐 Go | 📅 2026-05-15 - A Crypto-Secure, Production-Grade Reliable-UDP Library for Go with FEC.
...
* [clipboard](https://github.com/golang-design/clipboard) ⭐ 861 | 🐛 0 | 🌐 Go | 📅 2026-08-25 - Cross platform (MacOS/Linux/Windows/Android/iOS) clipboard package in Go.
...
* [aaaaxy](https://github.com/divVerent/aaaaxy) ⭐ 300 | 🐛 7 | 🌐 Go | 📅 2026-09-17 - A nonlinear 2D puzzle platformer taking place in non-Euclidean geometry.
...
* [aram-emu](https://github.com/mirusu400/aram-emu) ⭐ 5 | 🐛 0 | 🌐 Go | 📅 2026-09-17 - An emulator for Korean feature-phone software, the small games and apps that ran on 2000s WIPI handsets.
...
* [protozoa](https://github.com/Zebbeni/protozoa) ⭐ 36 | 🐛 0 | 🌐 Go | 📅 2026-09-17 - A simulation of protozoan behavior and evolution.
...
* [neko](https://github.com/crgimenes/neko) ⭐ 642 | 🐛 7 | 🌐 Go | 📅 2026-09-15 - Neko is a cross-platform open-source animated cursor-chasing cat.
* [wasmserve](https://github.com/hajimehoshi/wasmserve) ⭐ 292 | 🐛 1 | 🌐 Go | 📅 2025-09-02 - An HTTP server for Wasm testing like gopherjs serve.
* [kutta](https://github.com/crgimenes/kutta) ⭐ 140 | 🐛 1 | 🌐 Go | 📅 2026-09-15 - A 2D wind tunnel: qualitative airfoil flow with smoke streaklines, a scene editor and animated control surfaces.
...
* [tps-vs-fps](https://github.com/tinne26/tps-vs-fps) ⭐ 45 | 🐛 1 | 📅 2025-10-31 - Detailed explanation of how fps and tps work in Ebitengine.
