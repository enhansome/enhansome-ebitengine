...
[Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 13,491 | 🐛 288 | 🌐 Go | 📅 2026-09-19 is an open source game library for the Go programming language. Ebitengine's simple API allows you to quickly and easily develop 2D games that can be deployed across multiple platforms. Ebitengine is made by [Hajime Hoshi](https://github.com/hajimehoshi).

### Contributing

Please take a quick gander at the [contribution guidelines](https://github.com/sedyh/awesome-ebiten/blob/main/CONTRIBUTING.md) ⭐ 993 | 🐛 2 | 📅 2026-09-17 first. Thanks to all [contributors](https://github.com/sedyh/awesome-ebiten/graphs/contributors) ⭐ 993 | 🐛 2 | 📅 2026-09-17; you rock!
...
* [ebitenui](https://github.com/ebitenui/ebitenui) ⭐ 940 | 🐛 75 | 🌐 Go | 📅 2026-08-19 - A user interface engine and widget library for Ebitengine.
...
* [go-colorful](https://github.com/lucasb-eyer/go-colorful) ⭐ 1,255 | 🐛 10 | 🌐 Go | 📅 2026-08-02 - A complex library for handling color spaces and comparing colors.
* [tetra3d](https://github.com/SolarLune/Tetra3d) ⭐ 519 | 🐛 4 | 🌐 Go | 📅 2026-08-19 - A 3D software renderer written in Go by means of Ebitengine, primarily for video games.
...
* [ganim8](https://github.com/yohamta/ganim8) ⭐ 83 | 🐛 0 | 🌐 Go | 📅 2026-08-16 - An animation library for Ebitengine inspired by [anim8](https://github.com/kikito/anim8) ⭐ 995 | 🐛 7 | 🌐 Lua | 📅 2022-01-20.
...
* [jel](https://github.com/setanarut/jel) ⭐ 2 | 🐛 0 | 🌐 Go | 📅 2026-09-16 - 2D soft-body physics library with extensible architecture
...
* [kcp-go](https://github.com/xtaci/kcp-go) ⭐ 4,555 | 🐛 71 | 🌐 Go | 📅 2026-05-15 - A Crypto-Secure, Production-Grade Reliable-UDP Library for Go with FEC.
...
* [clipboard](https://github.com/golang-design/clipboard) ⭐ 862 | 🐛 0 | 🌐 Go | 📅 2026-08-25 - Cross platform (MacOS/Linux/Windows/Android/iOS) clipboard package in Go.
...
* [aaaaxy](https://github.com/divVerent/aaaaxy) ⭐ 300 | 🐛 7 | 🌐 Go | 📅 2026-09-19 - A nonlinear 2D puzzle platformer taking place in non-Euclidean geometry.
...
* [aram-emu](https://github.com/mirusu400/aram-emu) ⭐ 6 | 🐛 0 | 🌐 Go | 📅 2026-09-18 - An emulator for Korean feature-phone software, the small games and apps that ran on 2000s WIPI handsets.
...
* [protozoa](https://github.com/Zebbeni/protozoa) ⭐ 36 | 🐛 0 | 🌐 Go | 📅 2026-09-19 - A simulation of protozoan behavior and evolution.
...
* [neko](https://github.com/crgimenes/neko) ⭐ 643 | 🐛 7 | 🌐 Go | 📅 2026-09-15 - Neko is a cross-platform open-source animated cursor-chasing cat.
