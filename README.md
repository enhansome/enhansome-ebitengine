...
[Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 13,467 | 🐛 289 | 🌐 Go | 📅 2026-09-11 is an open source game library for the Go programming language. Ebitengine's simple API allows you to quickly and easily develop 2D games that can be deployed across multiple platforms. Ebitengine is made by [Hajime Hoshi](https://github.com/hajimehoshi).

### Contributing

Please take a quick gander at the [contribution guidelines](https://github.com/sedyh/awesome-ebiten/blob/main/CONTRIBUTING.md) ⭐ 989 | 🐛 1 | 📅 2026-09-11 first. Thanks to all [contributors](https://github.com/sedyh/awesome-ebiten/graphs/contributors) ⭐ 989 | 🐛 1 | 📅 2026-09-11; you rock!
...
* [looplab-fsm](https://github.com/looplab/fsm) ⭐ 3,415 | 🐛 29 | 🌐 Go | 📅 2026-08-27 - A Finite State Machine for Go.
* [donburi](https://github.com/yohamta/donburi) ⭐ 378 | 🐛 8 | 🌐 Go | 📅 2026-05-17 - Just another Entity Component System library for Ebitengine.
* [ark](https://github.com/mlange-42/ark) ⭐ 300 | 🐛 7 | 🌐 Go | 📅 2026-08-17 - An archetype-based Entity Component System for Go.
* [unitoftime-ecs](https://github.com/unitoftime/ecs) ⭐ 149 | 🐛 0 | 🌐 Go | 📅 2026-08-04 - A simple and generic ECS implementation in Go.
...
* [ebitenui](https://github.com/ebitenui/ebitenui) ⭐ 939 | 🐛 75 | 🌐 Go | 📅 2026-08-19 - A user interface engine and widget library for Ebitengine.
* [furex](https://github.com/yohamta/furex) ⭐ 169 | 🐛 8 | 🌐 Go | 📅 2026-07-18 - A simple UI framework with a subset of flexbox layout specification.
...
* [tetra3d](https://github.com/SolarLune/Tetra3d) ⭐ 515 | 🐛 4 | 🌐 Go | 📅 2026-08-19 - A 3D software renderer written in Go by means of Ebitengine, primarily for video games.
...
* [ganim8](https://github.com/yohamta/ganim8) ⭐ 83 | 🐛 0 | 🌐 Go | 📅 2026-08-16 - An animation library for Ebitengine inspired by [anim8](https://github.com/kikito/anim8) ⭐ 991 | 🐛 7 | 🌐 Lua | 📅 2022-01-20.
...
* [bitmapfont](https://github.com/hajimehoshi/bitmapfont) ⭐ 61 | 🐛 3 | 🌐 Go | 📅 2026-09-01 - A plug-and-play `font.Face`, that supports a wide range of languages and symbols
...
* [resound](https://github.com/SolarLune/resound) ⭐ 37 | 🐛 2 | 🌐 Go | 📅 2025-06-17 - A library for applying sound effects to Ebitengine games and controlling sound playback easily.
...
* [jel](https://github.com/setanarut/jel) ⭐ 0 | 🐛 0 | 🌐 Go | 📅 2026-09-11 - 2D soft-body physics library with extensible architecture
* [quark](https://github.com/setanarut/quark) ⭐ 0 | 🐛 0 | 🌐 Go | 📅 2026-08-25 - A Go port of [QuarkPhysics](https://github.com/erayzesen/QuarkPhysics) ⭐ 294 | 🐛 0 | 🌐 C++ | 📅 2025-10-17, a 2D physics engine for games.
...
* [kamera](https://github.com/setanarut/kamera) ⭐ 35 | 🐛 0 | 🌐 Go | 📅 2026-02-15 - A camera with noise shake, lerp motion, rotation and zooming.
...
* [tengo](https://github.com/d5/tengo) ⭐ 3,836 | 🐛 90 | 🌐 Go | 📅 2026-04-29 - Fast scripting language for Go.
* [go-lua](https://github.com/Shopify/go-lua) ⭐ 3,454 | 🐛 49 | 🌐 Go | 📅 2025-07-18 - Port of Lua VM in Go.
...
* [kcp-go](https://github.com/xtaci/kcp-go) ⭐ 4,553 | 🐛 70 | 🌐 Go | 📅 2026-05-15 - A Crypto-Secure, Production-Grade Reliable-UDP Library for Go with FEC.
...
* [clipboard](https://github.com/golang-design/clipboard) ⭐ 860 | 🐛 0 | 🌐 Go | 📅 2026-08-25 - Cross platform (MacOS/Linux/Windows/Android/iOS) clipboard package in Go.
...
* [aaaaxy](https://github.com/divVerent/aaaaxy) ⭐ 300 | 🐛 8 | 🌐 Go | 📅 2026-09-11 - A nonlinear 2D puzzle platformer taking place in non-Euclidean geometry.
...
* [aram-emu](https://github.com/mirusu400/aram-emu) ⭐ 3 | 🐛 1 | 🌐 Go | 📅 2026-09-11 - An emulator for Korean feature-phone software, the small games and apps that ran on 2000s WIPI handsets.
...
* [darktile](https://github.com/liamg/darktile) ⭐ 3,084 | 🐛 40 | 🌐 Go | 📅 2023-03-19 - A GPU rendered terminal emulator designed for tiling window managers.
* [neko](https://github.com/crgimenes/neko) ⭐ 638 | 🐛 7 | 🌐 Go | 📅 2026-08-22 - Neko is a cross-platform open-source animated cursor-chasing cat.
* [wasmserve](https://github.com/hajimehoshi/wasmserve) ⭐ 292 | 🐛 1 | 🌐 Go | 📅 2025-09-02 - An HTTP server for Wasm testing like gopherjs serve.
* [kutta](https://github.com/crgimenes/kutta) ⭐ 139 | 🐛 2 | 🌐 Go | 📅 2026-08-20 - A 2D wind tunnel: qualitative airfoil flow with smoke streaklines, a scene editor and animated control surfaces.
...
* [turtle](https://github.com/gary23b/turtle) ⭐ 3 | 🐛 0 | 🌐 Go | 📅 2025-02-27 - Turtle graphics. Teach Golang programming with instant visual feedback.
...
* [kage-desk](https://github.com/tinne26/kage-desk) ⭐ 121 | 🐛 0 | 🌐 Go | 📅 2026-03-12 - Gentle introduction to the Kage shading language.
